...
$query = "SELECT age FROM certificate"; // Fetch ages for scholarship applications
...
// Bar Chart: Fetch city data for certificate applicants
$query = "SELECT c.city_name, COUNT(*) as total_applicants
          FROM certificate ct
          JOIN cities c ON ct.city_id = c.city_id
...
$status_data_query = "SELECT status, COUNT(*) as count FROM certificate WHERE status IN ('Approved', 'Declined') GROUP BY status";
...
$approved_count_query = "SELECT COUNT(*) AS count FROM certificate WHERE status = 'Approved'";
$declined_count_query = "SELECT COUNT(*) AS count FROM certificate WHERE status = 'Declined'";
...
$applicants_query = "SELECT id, fName, lName, email, status FROM certificate WHERE status IN ('Approved', 'Declined') ORDER BY status";
